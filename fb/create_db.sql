...
CREATE DATABASE IF NOT EXISTS `kaggle_fb` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `kaggle_fb`;
...
-- Dumping structure for table kaggle_fb.temp
CREATE TABLE IF NOT EXISTS `temp` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='Temp data';
